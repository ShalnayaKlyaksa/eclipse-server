...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private const float PreviewHiddenWidth = 620f;
        ...
        private void ApplyResponsiveLayout()
        {
            ...
            var hidePreview = Width < PreviewHiddenWidth;

            HeaderPanel.Orientation = compact ? LayoutOrientation.Vertical : LayoutOrientation.Horizontal;
            ProfileActions.HorizontalAlignment = compact ? HAlignment.Stretch : HAlignment.Right;
            PreviewPanel.Visible = !hidePreview;
            PreviewPanel.MinWidth = compact ? 128f : 160f;
            SpriteView.Scale = compact ? new Vector2(5f, 5f) : new Vector2(6f, 6f);
        }
